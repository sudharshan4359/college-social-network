...
{   
		...
		sendmail('m.sudharshan4359@gmail.com',$_POST['name'],$_POST['email'],"Mail from College Social Network..",$msg);
            ...
            <ul class="spost_nav">
              <li>
                <div class="media wow fadeInDown"> <a href="#" class="media-left"> <img alt="" src="images/bveclogo.jpg"> </a>
                  <div class="media-body"> <a href="#" class="catg_title"> ; Poonamallee High Rd, Vishwas Nagar, Maduravoyal, Chennai, Tamil Nadu 600095</a> </div>
                </div>
              </li>
              <li>
                <div class="media wow fadeInDown"> <a href="#" class="media-left"> <img alt="" src="images/m3.jpg"> </a>
                  <div class="media-body"> <a href="#" class="catg_title"> Mail Us - m.sudharshan4359@gmail.com</a> </div>
                </div>
              </li>
              <li>
                <div class="media wow fadeInDown"> <a href="#" class="media-left"> <img alt="" src="images/call3.png"> </a>
                  <div class="media-body"> <a href="#" class="catg_title"> Call Us - +91 9652993480</a> </div>
                </div>
              </li>
